...
* Added Widgetized area on inner page header hero.
* Fix for main menu z-index when menu is on top of page.

= 1.4.12, 2017-07-05

* Added Customizer option for main menu to be above Home Hero 
