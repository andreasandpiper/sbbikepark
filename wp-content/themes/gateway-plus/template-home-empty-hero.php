...
/**
 *
 * Template Name: Home - Empty Hero
 *
 */
$home_header_layout = get_theme_mod( 'home_header_layout', 'below' );
	
if ( $home_header_layout == 'above'  ) {
		get_header( 'home-empty-hero-menu-top' );
	} else {
		get_header( 'home-empty-hero' );
	}

if ( get_theme_mod( 'home_featured_posts_checkbox', customizer_library_get_default( '1' ) ) ) { ?>
