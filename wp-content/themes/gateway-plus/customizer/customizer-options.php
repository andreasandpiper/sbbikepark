...
/*--------------------------------------------------------------
4.0.1 Home Menu Position
------------------------------------------------------------*/
	$section = 'home_header_layout';
	
	$sections[] = array(
		'id' 			=> $section,
		'title' 		=> __( 'Home Menu', 'gateway-plus' ),
		'priority' 		=> '20',
		'description' 	=> '',
		'panel' => $panel
	);
	...
	$options['home_header_layout'] = array(
		'id' => 'home_header_layout',
		'label'   => __( 'Home Menu Position', 'gateway-plus' ),
		'section' => $section,
		'type'    => 'radio',
		'choices' => $home_header_layout,
		'default' => 'below',
		'description' 	=> __( 'The position of the menu on the home page. Above or below the Home Hero Image/Slider', 'gateway-plus' ),
	);
/*--------------------------------------------------------------
4.1 Background Image
--------------------------------------------------------------*/
